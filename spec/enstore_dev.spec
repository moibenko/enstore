...
if [ ! -d ~enstore/site_specific/config ]; then
...
echo "Copying $ENSTORE_DIR/bin/enstore-boot.service to /usr/lib/systemd/system/enstore.service"
...
echo "Copying $ENSTORE_DIR/bin/monitor-boot.service to /usr/lib/systemd/system/enstore-monitor.service"
