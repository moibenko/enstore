...
class PriSelector(object):
    ...
    def read_config(self):
        ...
        self.base_pri_keys = list(self.base_dict.keys())
        self.admin_pri_keys = list(self.adm_dict.keys())
    ...
    def priority(self, ticket):
        ...
        for pri_key in pri_keys:
            conf_keys = list(self.prioritydict[pri_key].keys())
            nkeys = len(conf_keys)
            nmatches = 0
