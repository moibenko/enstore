...
class EnstoreSystemHtml(object):
    def __init__(self, name, bytes_dict, remote=False):
        ...
        add_row_to_table(self.status_table,
                         "/cgi-bin/enstore_show_inv_summary_cgi",  # Need constant???
                         "Tape Inventory Summary",
                         "Summary of inventory results")
        add_row_to_table(self.status_table,
                         "/cgi-bin/enstore_show_inventory_cgi",  # Need constant???
                         "Tape Inventory",
