...
class dsDB(object):
    ...
    def log_stat(self,
        ...
        values = {
            ...
            "power_hrs": int(power_hrs) if power_hrs else 0,
            "motion_hrs": int(motion_hrs) if motion_hrs else 0,
            "cleaning_bit": cleaning_bit,
            "mb_user_read": int(mb_user_read),
            "mb_user_write": int(mb_user_write),
            "mb_dev_read": int(mb_dev_read),
            "mb_dev_write": int(mb_dev_write),
