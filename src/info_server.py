...
class Server(volume_clerk.VolumeClerkInfoMethods,
    ...
    def __find_file(self, bfid, ticket, error_target, item_name=None,
        ...
        if 'file_list' in ticket:
            ...
            if item_name:
                ...
                for key in list(combined_dict.keys()):
    ...
    def __find_file_by_path(self, ticket):
        ticket['status'] = (
            e_errors.INFO_SERVER_ERROR,
            "lookup by path disabled, use bfid, of pnfsid")
        return
...
if __name__ == "__main__":   # pragma: no cover
    ...
    while True:
        try:
            ...
            infoServer.serve_forever_error(MY_NAME.upper())
            continue
