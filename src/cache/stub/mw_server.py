...
class MWs(object):
    ...
    def __init__(self, cs, name):
        ...
        self.trace.log(
            "create %s server instance, qpid client instance",
            self.name)
...
if __name__ == "__main__":   # pragma: no cover
    ...
    # log.encache.messaging and log.encache.<migration workers> inherit from
    # log.encache
    log, trace = cache.en_logging.config_test_unit.set_logging_console(
        name, full_name=MY_FULL_NAME)
