...
class TestHostaddr(unittest.TestCase):
    ...
    def setUp(self):
        ...
        socket.getaddrinfo.return_value = [(2, 1, 6, '', ('131.225.105.239', 0)), (
            2, 2, 17, '', ('131.225.105.239', 0)), (2, 3, 0, '', ('131.225.105.239', 0))]
    ...
    def test_gethostinfo(self):
        ...
        self.assertTrue(isinstance(hostinfo, list))
    ...
    def test_address_to_name(self):
        ...
        self.assertTrue(isinstance(atn, bytes))
    ...
    def test_name_to_address(self):
        ...
        self.assertTrue(isinstance(nta, bytes))
    ...
    def test_update_domains(self):
        ...
        self.assertEqual(
            hostaddr.GL_known_domains['invalid_domains']['default2'],
            ['999.999'])
    ...
    def test_find_ifconfig_command(self):
        ...
        if if_cmd:
            self.assertTrue(isinstance(if_cmd, bytes))
