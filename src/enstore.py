...
class EnstoreInterface(object):
    ...
    def get_all_servers(self):
        if not self.user_mode:
            scripts = sorted(list(local_scripts.keys()) + list(remote_scripts.keys()))
        else:
            scripts = []
...
class Enstore(object):
    ...
    def do_work(self):
        ...
        rtn = 0
        if arg1 in list(local_scripts.keys()):
        ...
        elif arg1 in list(remote_scripts.keys()):
