...
# define as global, otherwise exec in Pyhton 3 does not work
configdict = {}
...
class WebServer(object):
    ...
    def write_httpd_conf(self):
        ...
        try:
                    ...
                    for key in self.server_dict:
                        ...
                        if indx == 0 and key == line.split()[0].strip():
                            if key == "CustomLog":
                                ...
                                # type of log files
                                #
                                for k in list(self.server_dict[key].keys()):
            ...
            print(str(msg))
            for l in traceback.format_exception(sys.exc_info()[0], sys.exc_info()[1],
                   sys.exc_info()[2]):
                print(l)
            rc = 1
        f.close()
