...
def decode_job(job):
    if job[:3] == 'STK' or job[:3] == "CDF":
        ...
        if job[3] in ['a', 'r', 's', 't']:
            ...
            type = job[5]
            t = job[6:].split('-')
            job_range = list(range(int(t[0]), int(t[1]) + 1))
        else:
            lt = '9310'
            type = job[4]
            t = job[5:].split('-')
...
def create_job(name, type, args, comment=''):
    ...
    if problem_args:
        for i in list(problem_args.keys()):
...
def help(myname, topic=None):
    if not topic:
        print(
            "{} create write_protect_on|write_protect_off <job> [[<association>:] [<associate>:]<object>]+".format(myname))
        print("    -- creating a job")
        print(
            "{} list [all|open|finished|closed|completed|<job>+|has <object>]|recent <n>".format(myname))
        print("    -- list job(s)")
        print("{} show <job>+".format(myname))
        print("    -- show details of job(s)")
        print("{} current <job>+".format(myname))
        print("    -- show current task(s) of <job>(s)")
        print("{} next <job>+".format(myname))
        print("    -- show next task(s) of <job>(s)")
        print("{} start <job> [<arg>]".format(myname))
        print("    -- start the next task of <job>")
        print("{} finish <job> [<result>]".format(myname))
        print("    -- finish the current task of <job>")
        print("{} delete <job>+ [sincerely]".format(myname))
        print("    -- delete <job>(s)")
        print("{} find|locate <object>+".format(myname))
        print("    -- find jobs that have <object>")
        print("{} find+|locate+ <objects>+".format(myname))
        print("    -- find|locate with details")
        print("{} relate <job>+".format(myname))
        print("    -- find jobs that have common objects")
        print(
            "{} recommend_write_protect_on [<library_list>] [limit <n>]".format(myname))
        print("    -- recommend volumes for flipping write protect tab on")
        print(
            "{} recommend_write_protect_off [<library_list>] [limit <n>]".format(myname))
        print("    -- recommend volumes for flipping write protect tab off")
        print("{} auto_write_protect_on [<library_list>] [no_limit]".format(myname))
        print("    -- automatically generate helpdesk ticket for flipping WP on")
        print(
            "{} auto_write_protect_off [<library_list>] [no_limit]".format(myname))
        print("    -- automatically generate helpdesk ticket for flipping WP off")
        print("{} auto_close_all".format(myname))
        print("    -- try to close all finished open jobs on this cluster")
        print()
        print("try:")
        print("{} help <topic>".format(myname))
    elif topic == "create":
        print()
        print(
            "{} create write_protect_on|write_protect_off <job> [[<association>:] [<associate>:]<object>]+".format(myname))
        ...
        print()
        print("EXAMPLE:")
        print("{} create write_protect_on WP3 CAP3:  VO2093 VO2094 VO2095 VO2096 VO2097 VO2098 VO2099 VO2152 VO2154 VO2195 VO2196 VO2197 VO2198 VO2199 VO2203 VO2206 VO2207 VO2208 VO2209 VO2211 VO2213 CAP4: VO2224 VO2225 VO2226 VO2227 VO2245 VO2246 VO2252 VO2253 VO2254 VO2256 VO2257 VO2258 VO2259 VO2501 VO2532 VO2533 VO2534 VO2540 VO2541 VO2542 VO2544".format(myname))
    elif topic == "list":
        print()
        print(
            "{} list [all|open|finished|closed|completed|<job>+|has <object>]".format(myname))
        print()
        ...
        print()
        print("EXAMPLE:")
        print("{} start STKWP3 <help_desk_ticket_id>".format(myname))
    elif topic == "finish":
        print()
        print("{} finish <job> [<result>]".format(myname))
        print()
        ...
        print("EXAMPLE:")
        print("{} finish STKWP3 DONE".format(myname))
    elif topic == "delete":
        print()
        print("{} delete <job>+ [sincerely]".format(myname))
        print()
        ...
        print()
        print("EXAMPLES:")
        print("{} recommend_write_protect_on".format(myname))
        print("{} recommend_write_protect_on 9940,CD-9940B".format(myname))
        print("{} recommend_write_protect_on limit 100".format(myname))
        print("{} recommend_write_protect_on 9940,CD-9940B limit 100".format(myname))
        print("{} recommend_write_protect_off".format(myname))
        print("{} recommend_write_protect_off 9940,CD-9940B".format(myname))
        print("{} recommend_write_protect_off limit 100".format(myname))
        print("{} recommend_write_protect_off 9940,CD-9940B limit 100".format(myname))
        ...
        print()
        print("EXAMPLES:")
        print("{} auto_write_protect_on".format(myname))
        print("{} auto_write_protect_on 9940,CD-9940B".format(myname))
        print("{} auto_write_protect_on no_limit".format(myname))
        print("{} auto_write_protect_on 9940,CD-9940B no_limit".format(myname))
        print("{} auto_write_protect_off".format(myname))
        print("{} auto_write_protect_off 9940,CD-9940B".format(myname))
        print("{} auto_write_protect_off no_limit".format(myname))
        print("{} auto_write_protect_off 9940,CD-9940B no_limit".format(myname))
...
def dump():
    for i in list(__builtins__.globals().keys()):
        if i[:2] == '__':       # internal
            continue
