...
class InquisitorPlots(object):
    ...
    def get_bpd_files(self):
        ...
        for node in list(nodes_and_dirs.keys()):
    ...
    def plot(self, encp, mount, sg, total_bytes):
        ...
        if sg:
            ...
            alt_key = Trace.MSG_ADD_TO_LMQ.strip()
