...
def aci_drivestatus(clientname):
    ...
    if isinstance(x, type([])):
        if isinstance(x[1], type("")):
            # SWIG 1.1
            return x[0], list(map(aci_shadow.aci_drive_entry, x[1:]))
        else:
            # SWIG 1.3
            return x[0], x[1:]
    else:
...
def aci_drivestatus3(clientname):
    ...
    if isinstance(x, type([])):
        if isinstance(x[1], type("")):
            # SWIG 1.1
            return x[0], list(map(aci_shadow.aci_ext_drive_entry, x[1:]))
        else:
            # SWIG 1.3
            return x[0], x[1:]
    else:
...
def aci_drivestatus4(clientname, drivename):
    ...
    if isinstance(x, type([])):
        if isinstance(x[1], type("")):
            # SWIG 1.1
            return x[0], list(map(aci_shadow.aci_ext_drive_entry4, x[1:]))
        else:
            # SWIG 1.3
            return x[0], x[1:]
    else:
...
def aci_list(clientname):
    ...
    if isinstance(x, type([])):
        if isinstance(x[1], type("")):
            # SWIG 1.1
            return x[0], list(map(aci_shadow.aci_req_entry, x[1:]))
        else:
            # SWIG 1.3
            return x[0], x[1:]
    else:
...
def aci_qvolsrange(start, end, max_count, clientname):
    ...
    if isinstance(x, type([])):
        ...
        if isinstance(x[2], type("")):
            # SWIG 1.1
            return x[0], x[1], list(map(aci_shadow.aci_volserinfo, x[2:]))
        else:
            # SWIG 1.3
            return x[0], x[1], x[2:]
    else:
...
def aci_getcellinfo(device, media_type, attrib):
    ...
    if isinstance(x, type([])):
        if isinstance(x[1], type("")):
            # SWIG 1.1
            return x[0], list(map(aci_shadow.aci_media_info, x[1:]))
        else:
            # SWIG 1.3
            return x[0], x[1:]
    else:
...
def aci_insert(io_area):
    ...
    if isinstance(x, list):
        if isinstance(x[1], str):
            ...
            return x[0], list([x.strip for x in volser_list])
        else:
            # SWIG 1.3
